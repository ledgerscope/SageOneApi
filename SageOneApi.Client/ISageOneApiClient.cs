...
namespace SageOneApi.Client
{
	...
	public interface ISageOneApiClient
	{
		...
		/// <summary>Retrieve <see cref="SageOneSingleAccountingEntity"/> item where there is only ever one of them per company.</summary>
		...
		/// <summary>Retrieve <see cref="SageOneCoreEntity"/> item where there is only ever one of them per company.</summary>
		...
		/// <summary>Retrieve <see cref="SageOneAccountingEntity"/> items where there could be multiple items per company.</summary>
		...
		/// <summary>Retrieve <see cref="SageOneCoreEntity"/> items where there could be multiple items per company.</summary>
